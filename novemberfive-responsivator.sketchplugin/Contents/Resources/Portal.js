    ...
    /***/ function(module, exports, __webpack_require__) {
            ...
            value: function renderLayer() {
              ...
              if (into !== this.intoPointer) {
                ...
                if (this.into && this.remote) {
                  this.remote = (0, _preact.render)(
                    (0, _preact.h)(PortalProxy, null),
                    this.into,
                    this.remote
                  )
                }
      ...
      var PortalProxy = (function(_Component2) {
        ...
        function PortalProxy() {
          ...
          return _possibleConstructorReturn(
            this,
            (PortalProxy.__proto__ || Object.getPrototypeOf(PortalProxy)).apply(
              this,
              arguments
            )
          )
    ...
    /***/ function(module, exports, __webpack_require__) {
      !(function(global, factory) {
        ...
        function setAccessor(node, name, old, value, isSvg) {
          ...
          if ('class' === name && value && 'object' == typeof value)
          ...
          if ('key' === name);
            ...
            if (value && 'object' == typeof value) {
              ...
              for (var i in value)
                node.style[i] =
                  'number' == typeof value[i] && !NON_DIMENSION_PROPS[i]
                    ? value[i] + 'px'
                    : value[i]
            }
        ...
        function innerDiffNode(dom, vchildren, context, mountAll, absorb) {
          ...
          if (keyedLen)
            for (var i in keyed) if (keyed[i]) recollectNodeTree(keyed[i])
