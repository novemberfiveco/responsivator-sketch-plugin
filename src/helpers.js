...
export function findFirstLayerMatchingPredicateInContainerFilterByType (document, predicate, container, layerType) {
...
export function findLayersNamed (document, layerNames, container, layerType) {
  let predicate
...
export function findLayersOfType (document, layerType, container) {
  let predicate = NSPredicate.predicateWithFormat('class == %@', layerType)
  return findLayersMatchingPredicateInContainerFilterByType(document, predicate, container)
}

// Search for Artboards by Name
export function findArtboardsNamed (document, artboardName, container) {
...
export function findArtboardsNamedLike (document, artboardNames, container) {
  let predicate
...
export function findPagesNamed (document, pageName) {
...
export function findPagesNamedLike (document, pageName) {
  let predicate = NSPredicate.predicateWithFormat('name LIKE[c] %@', pageName)
  return findLayersMatchingPredicateInContainerFilterByType(document, predicate, null, ModelClasses.MSPage)
}

export function findLayersByRegexInContainer (document, layerType, containerLayer) {
...
export function selectLayersByRegexInContainer (document, layerName, containerLayer) {
  // Filter layers using NSPredicate
  let scope = (typeof containerLayer !== 'undefined') ? containerLayer.children() : document.currentPage().children()
...
export function selectLayersByRegexAndTypeInContainer (document, layerName, layerType, containerLayer) {
  // Filter layers using NSPredicate
...
export function getPluginInfo (context) {
...
export function getPluginDirectory (context) {
